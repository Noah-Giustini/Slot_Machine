...
public class TestSlotMachine {
	...
	public void test_getReels() {
        ...
        Reel reel3 = new Reel(2);
        Game g = new Game(reel1, reel2, reel3);
        assertEquals("Reel1 should match", reel1.getReel(), g.getLeftList());
        assertEquals("Reel2 should match", reel2.getReel(), g.getMidList());
        assertEquals("Reel3 should match", reel3.getReel(), g.getRightList());
	}
